...
def plot_f1_scores(handcrafted_csv):
    train_sizes_hand, f1_scores_hand, label_hand = evaluate_classifier(handcrafted_csv, "Gesture recognitions") 
...
plot_f1_scores(handcrafted_csv)